...
const EditarCitaSecretary: React.FC = () => {
    ...
    const fetchAppointmentDetails = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setSelectedPatient(appointment.body.data[0].idUsuarioCC);
    ...
    return (
        ...
        <>
            ...
            <div className="calendar-container">
                ...
                <h1>Seleccione una nueva fecha y hora para reagendamiento</h1>
                <div className="service-select-wrapper">
                    <label htmlFor="service-select">Usuario:</label>
                    <select
                        id="service-select"
                    ...
                    >
                        ...
                        {users.map((user) => (
                            <option key={user.CC} value={user.CC}>
                ...
                <button
                    className="schedule-button"
                    onClick={() => navigate(`/secretary/citas`)} 
                >
                    Cancelar
                </button>
            </div>
...
export default EditarCitaSecretary;
